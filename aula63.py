...
import sys                                                                          # sys.exit() é um método que sai do python
...
cpf_enviado_usuario = re.sub(                                                       # 'sub' de substituir
    r'[^0-9]',                                                                      # substituir qualquer coisa de 0 a 9 que não seja um número '^' = não
    '',                                                                             # quero que substitua por '' no caso NADA
    entrada                                                                         # valor original que vai ser alterado
)

entrada_e_sequencial = entrada == entrada[0] * len(entrada)
# aqui eu checo se a 'entrada' é igual o primeiro caractere da entrada repetido até o final
